...
Helper package to render [Galixir](https://github.com/laszlokorte/galixir) [Geometric Algebra](https://bivector.net/) objects in Livebook
...
# define some circles from a centere and radius
